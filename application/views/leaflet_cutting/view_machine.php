    ...
    <div class=content>
        <div class=content-header>
            ...
            <div class=header-title>
                <h1>View label & leaflet cutting</h1>
                <small></small>
                <ol class=breadcrumb>
                    <li>
                        <i class=pe-7s-home></i> Home</li>
                    <li class="active">View label & leaflet cutting</li>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">Shift : <div class="radio radio-inline">
                                                        <input type="radio" disabled="" id="inlineradio1" value="G" name="shift" <?php if($data['shift'] == 'G') echo 'checked' ?>>
                                                        <label for="inlineradio1"> G </label>
                                                    </div></e><e class="aks_value"><div style="margin-left: 11px;" class="radio radio-inline">
                                                        <input type="radio" disabled id="inlineradio2" value="N" name="shift" <?php if($data['shift'] == 'N') echo 'checked' ?>>
                                        ...
                                        <tr>
                                            <td>Paper sizee : <u><?php echo $data['paper'] ?></u></td>
                                            <td colspan="">Quantity : <u><?php echo $data['quantity'] ?></u></td>
                                            <td colspan="">Conversion : <u><?php echo $data['conversion'] ?></u></td>
                                        ...
                                        <tr>
                                            <td colspan="">Waste : <u><?php echo $data['waste'] ?></u></td>
                                            <td colspan="2">Remarks : <u><?php echo $data['remarks'] ?></u></td>
