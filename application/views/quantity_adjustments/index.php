										    ...
										    <tbody>
												...
												<tr>
													...
													<td>
														...
														?>
														<a href="<?php echo base_url() ?>quantity_adjustments/edit/<?php echo $module["id"] ?>"><img src="<?php echo base_url() ?>assets/icons/edit.png" title="Edit" alt="Edit" width="35" height="35"></a>
														<?php } ?>
														<?php 
