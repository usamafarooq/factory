                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php 
                                                            if ($module['reports'] == 0) {
                                                        ?>
                                                        <a href="<?php echo base_url() ?>design/report_submit/<?php echo $module["id"] ?>"><img src="<?php echo base_url() ?>assets/icons/report_submit.png" title="Report Submit" alt="Report Submit" width="35" height="35"></a>
                                                        <?php 
                                                            }
                                                            else{
