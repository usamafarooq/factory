										    ...
										    <tbody>
										    	...
										    	<tr>
										    		...
										    		<td>
										    			...
										    			?>
										    			<a href="<?php echo base_url() ?>requisition/order/<?php echo $o["WO_no"] ?>/Cutting?redirect=<?php echo $url ?>"><button class="btn btn-info">Order</button></a>
										    			<?php } ?>
										    			...
										    			?>
										    			<a href="<?php echo base_url() ?>cutting/view_machine/<?php echo $o["id"] ?>/<?php echo $o['flow_id'] ?>"><img src="<?php echo base_url() ?>assets/record1.png" title="View Plane" alt="View Plane" width="35" height="35"></a>
										    			<?php
										    					if ($o['submit'] == 0) {
										    			?>
