										    ...
										    <tbody>
										    	...
										    	<tr>
										    		...
										    		<td>
										    			...
										    			<?php 
										    				if ($o['con'] == 0) {
										    					echo '<a href="'.base_url('machine_flow/plate_making_start/'.$o['id'].'/'.$o['flow_id']).'"><button class="btn btn-info">Start</button></a>';
										    				}
										    				else{
										    					if ($o['submit'] == 0) {
										    						echo '<a href="'.base_url('machine_flow/plate_making_complete/'.$o['id'].'/'.$o['flow_id']).'"><button class="btn btn-info">Complete</button></a>';
										    					}
										    					else{
										    						echo 'completed';
										    					}
