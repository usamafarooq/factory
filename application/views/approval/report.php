                    ...
                    <div class="panel panel-bd ">
                        ...
                        <div class="panel-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9"
                                    ><input class="form-control" name="remarks" type="text" value="" id="example-text-input" placeholder="" >
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="example-text-input" class="col-sm-3 col-form-label">File</label>
                                <div class="col-sm-9"
                                    ><input class="form-control" name="file" type="file" value="" id="example-text-input" placeholder="" >
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-12">
