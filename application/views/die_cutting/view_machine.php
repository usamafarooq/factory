    ...
    <div class=content>
        <div class=content-header>
            ...
            <div class=header-title>
                <h1>View Die Cutting Machine</h1>
                <small></small>
                <ol class=breadcrumb>
                    <li>
                        <i class=pe-7s-home></i> Home</li>
                    <li class="active">View Die Cutting Machine</li>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <tr>
                                            <td colspan="3">Process : <div class="radio radio-inline">
                                                        <input type="radio" disabled=""  id="inlineradio3" name="process" value="Cutting" <?php if($data['process'] == 'Cutting') echo 'checked' ?>>
                                                        <label for="inlineradio3"> Cutting </label>
                                                    </div></e><e class="aks_value"><div style="margin-left: 11px;" class="radio radio-inline">
                                                        <input type="radio" disabled="" id="inlineradio4" name="process" value="Embossing" <?php if($data['process'] == 'Embossing') echo 'checked' ?>>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">Die set : <div class="radio radio-inline">
                                                        <input type="radio" disabled="" id="inlineradio11" value="Yes" name="die" <?php if($data_complete['die'] == 'Yes') echo 'checked' ?>>
                                                        <label for="inlineradio11"> Yes </label>
                                                    </div></e><e class="aks_value"><div style="margin-left: 11px;" class="radio radio-inline">
                                                        <input type="radio" disabled="" id="inlineradio12" value="No" name="die" <?php if($data_complete['die'] == 'No') echo 'checked' ?>>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">Plate set : <div class="radio radio-inline">
                                                        <input type="radio" disabled="" id="inlineradio15" value="Yes" name="plate" <?php if($data_complete['plate'] == 'Yes') echo 'checked' ?>>
                                                        <label for="inlineradio15"> Yes </label>
                                                    </div></e><e class="aks_value"><div style="margin-left: 11px;" class="radio radio-inline">
                                                        <input type="radio" disabled="" id="inlineradio6" value="No" name="plate" <?php if($data_complete['plate'] == 'No') echo 'checked' ?>>
