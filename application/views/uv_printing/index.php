										    ...
										    <tbody>
										    	...
										    	<tr>
										    		...
										    		<td>
										    			...
										    			?>
										    			<a href="<?php echo base_url() ?>requisition/order/<?php echo $o["WO_no"] ?>/UV_Printing?redirect=<?php echo $url ?>"><button class="btn btn-info">Order</button></a>
										    			<?php } ?>
										    			...
										    			<?php 
										    				if ($o['con'] == 0) {
										    					echo '<a href="'.base_url('machine_flow/uv_printing_start/'.$o['id'].'/'.$o['flow_id']).'"><button class="btn btn-info">Start</button></a>';
										    				}
										    				else{
										    					if ($o['submit'] == 0) {
										    						echo '<a href="'.base_url('machine_flow/uv_printing_complete/'.$o['id'].'/'.$o['flow_id']).'"><button class="btn btn-info">Complete</button></a>';
										    					}
										    					else{
										    						echo 'completed';
										    					}
